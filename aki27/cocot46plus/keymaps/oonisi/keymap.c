...
void matrix_init_user(void) {
    uint16_t on_keys[]  = {KC_N, KC_M};
    uint16_t off_keys[] = {KC_V, KC_B};
    layer_chord_init(on_keys, off_keys);
}
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_OONISI] = LAYOUT(
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
      KC_TRNS, KC_Q,  KC_L,    KC_U,    KC_COMM, KC_DOT,                                           KC_F,    KC_W,    KC_R,    KC_Y,   KC_P,  KC_TRNS,
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
      KC_TRNS, KC_E,  KC_I,    KC_A,    KC_O,    KC_MINS,                                          KC_K,    KC_T,    KC_N,    KC_S,   KC_H,  KC_TRNS,
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
      KC_TRNS,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_SCLN,                                     KC_G,    KC_D,    KC_M,    KC_J,   KC_B,  KC_TRNS,
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
                        KC_TRNS, MO(3),   KC_LSFT,  KC_TRNS, MS_BTN1,             MS_BTN2,  KC_TRNS, KC_RSFT, KC_RGUI,  LCTL(KC_DOWN),
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [_OONISI]  = { ENCODER_CCW_CW(KC_PGUP, KC_PGDN) },
    [_NUMBERS]    = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU) },
};
#endif

bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    if (!process_layer_chord(keycode, record)) {
        return false;
    }
    return true;
}
